    ...
    return (
        ...
        /* <div id="myCarousel" className="carousel slide mb-6 carousel-fade" data-bs-ride="carousel" >
            ...
            <div className="carousel-inner">
                ...
                <div className="carousel-item">
                    <Image src='/assets/images/img02.jpg' width="1100" height='500' className="d-block w-100" alt="slide01" />
                    <div className="container">
                ...
                <div className="carousel-item">
                    <Image src='/assets/images/img03.jpg' width="1100" height='500' className="d-block w-100" alt="slide01" />
                    <div className="container">
                ...
                <div className="carousel-item">
                    <Image src='/assets/images/img04.jpg' width="1100" height='500' className="d-block w-100" alt="slide01" />
                    <div className="container">
                        <div className="carousel-caption text-end">
                            <h1>One more for good measure.</h1>
                            <p>Some representative placeholder content for the third slide of this carousel.</p>
