    ...
    return (
        <div className="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mx-auto text-center">
            ...
            <div className="text-center text-sky-600 font-bold">
                ...
                <h3 className="text-2xl">00</h3>
            </div>
            <div className="max-w-4xl mx-auto">
                <div className="mt-20 px-4 flex justify-center space-x-6">
                    <button className="bg-lime-500 text-white px-4 py-2 rounded-2xl shadow-lg shadow-lime-500/20">(+)</button>
                    <button className="bg-indigo-500 text-white px-4 py-2 rounded-full shadow-md shadow-indigo-600/30">(-)</button>
                </div>
            </div>
        </div>
    )
