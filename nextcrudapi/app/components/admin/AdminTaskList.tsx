...
const AdminTaskList = ({ allTasksList }: Props) => {
                                ...
                                <tbody className="divide-y divide-gray-200">
                                    {
                                        allTasksList.map((task, index) => (
                                            <tr key={index}>
                                                ...
                                                <td className="py-4 text-sm pl-32 font-medium whitespace-nowrap">
                                                    <Link href={`/admin/tasks/edit/${task._id}`}>
                                                        <FiEdit className="text-blue-500 text-center" size={20} />
                                                    </Link>
                                                </td>
                                                <td className="pl-36">
                                                    <Link href={`/admin/tasks/edit-task/${task._id}`}>
                                                        <FiEdit className="text-blue-500 text-center" size={20} />
                                                    </Link>
                                                </td>
