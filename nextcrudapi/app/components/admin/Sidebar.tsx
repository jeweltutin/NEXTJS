import { FaBolt, FaChevronLeft, FaChevronRight, FaRegCalendarAlt, FaRegChartBar, FaRegStickyNote, FaRegSun, FaStickyNote, FaTachometerAlt, FaWrench } from "react-icons/fa";
