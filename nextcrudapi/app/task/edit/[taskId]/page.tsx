            ...
            <div className="text-center my-100 flex flex-col gap-4">
                ...
                <form method="dialog" onSubmit={handleSubmitEditTodo} className="modal-box m-auto">
                    ...
                    <div className="form-control w-full max-w-xs m-auto">
                        ...
                        <input type="text" name="time" defaultValue={data.time} placeholder="Time:" className="input input-bordered w-full max-w-xs mb-4" />
                        <button type="submit" className="btn btn-success text-black">Save</button>
                    </div>
                </form>
