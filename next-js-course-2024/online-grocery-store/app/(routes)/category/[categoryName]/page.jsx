        ...
        <div className="container mx-auto">
            <div className="relative">
                ...
                <div className="mb-7 border rounded-md">
                    <Image src={theCategory[0]?.banner?.url ? process.env.NEXT_PUBLIC_BACKEND_BASE_URL + theCategory[0]?.banner?.url : '/images/default-cat-banner.jpg'} width={600} height={200} alt="" className="w-full max-h-[200px] object-cover" />
                </div>
