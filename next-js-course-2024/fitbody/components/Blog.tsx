      ...
      <div className="container mx-auto">
        ...
        >
          <Swiper
            ...
            {blogData.map((post, index) => {
              return (
                <SwiperSlide key={index}>
                  <div className="flex flex-col justify-start mx-auto h-full max-w-[320px]">
                    <Image src={post.img} width={320} height={266} alt="" className="mb-6" />
                    <div className="flex flex-col items-start">
                      <p className="max-w-[380px] uppercase tracking-[3px] mb-1">{post.date}</p>
            ...
            <SwiperNavButtons
              containerStyles="absolute left-0 right-0 bottom-[16rem] w-full  z-50 mx-auto flex justify-between gap-1 max-w-[370px] sm:max-w-[620px] md:max-w-[960px] xl:max-w-[1320px]"
              btnStyles="bg-accent text-white w-[56px] h-[56px] flex justify-center items-center hover:bg-red-300 transition-all duration-300"
              iconStyles="text-2xl" />
          </Swiper>
        </motion.div>
