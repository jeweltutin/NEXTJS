        ...
        <div className='flex items-center justify-between mb-8'>
          ...
          <div className='flex gap-2 md:gap-4 items-center'>
            <Button
              ...
              addClasses='flex flex-row-reverse gap-1 items-center  text-black text-sm md:text-base rounded-md 2xl:py-2.5'
              onClick={() => restoreAllClick()}
            />
            <Button
              label='Delete All'
              icon={<MdDelete className='text-lg hidden md:flex' />}
              addClasses='flex flex-row-reverse gap-1 items-center  text-red-600 text-sm md:text-base rounded-md 2xl:py-2.5'
